...
public class Pembunuh implements Kelas {
    ...
    public void serang(Karakter self, Karakter target) {
        System.out.println(self.getName() + ", sang pembunuh, menyerang " + target.getName() + " dengan " + senjata);
    ...
    public void gunakanKemampuan(Karakter self, Karakter target) {
        ...
        int healthYangDiserap = Math.min(20, target.getHealth());
        System.out.println(self.getName() + " menyerap health " + target.getName() + " sebesar " + healthYangDiserap);
        target.terimaSerangan(healthYangDiserap);
        self.addHealth(healthYangDiserap);
    }
