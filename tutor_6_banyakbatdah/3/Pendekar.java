...
public class Pendekar implements Kelas {
    ...
    public void serang(Karakter self, Karakter target) {
        System.out.println(self.getName() + ", sang pendekar, menyerang " + target.getName() + " dengan " + senjata);
    ...
    public void gunakanKemampuan(Karakter self, Karakter target) {
        ...
        System.out.println(self.getName() + " memukul mundur " + target.getName() + " dengan " + perisai);
    ...
    public void gunakanUltimate(Karakter self, Karakter target) {
        ...
        System.out.println(self.getName() + " menyerang " + target.getName() + " dengan " + senjata + " dan " + perisai);
